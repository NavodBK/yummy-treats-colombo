...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "WhatsApp",
      url: "https://whatsapp.com/channel/0029VbCB2qOISTkRcfU1X23e",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <a
              href="https://whatsapp.com/channel/0029VbCB2qOISTkRcfU1X23e"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-background/60">
          ...
          <p className="flex items-center gap-1">
            Made with <Heart className="h-4 w-4 text-primary fill-primary animate-pulse" /> in Colombo
          </p>
        </div>
      </div>
    </footer>
